...
mod tests_cir {
    ...
    #[test]
    fn test_cox_ingersoll_ross_euler_maruyama() {
    ...
    #[test]
    fn test_cox_ingersoll_ross_euler_maruyama_seeded() {
        let cir = CoxIngersollRoss::new(0.15, 0.45, 0.01);
    ...
    #[test]
    fn test_cox_ingersoll_ross_milstein() {
        let cir = CoxIngersollRoss::new(0.15, 0.45, 0.01);

        let config = StochasticProcessConfig::new(10.0, 0.0, 0.5, 100, 100, false, None);

        let output = cir.milstein(&config);
    ...
    #[test]
    fn test_cox_ingersoll_ross_milstein_seeded() {
        let cir = CoxIngersollRoss::new(0.15, 0.45, 0.01);
    ...
    #[test]
    fn test_cox_ingersoll_ross_strang_splitting() {
        let cir = CoxIngersollRoss::new(0.15, 0.45, 0.01);

        let config = StochasticProcessConfig::new(10.0, 0.0, 0.5, 100, 100, false, None);

        let output = cir.strang_splitting(&config);
    ...
    #[test]
    fn test_cox_ingersoll_ross_strang_splitting_seeded() {
        let cir = CoxIngersollRoss::new(0.15, 0.45, 0.01);
